...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_hole_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 54, 21)
    ...
    "hole\0on_nextButton_clicked\0\0"
...
const QMetaObject hole::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_hole.data,
      qt_meta_data_hole,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_hole.stringdata))
