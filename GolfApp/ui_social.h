...
public:
    ...
    void setupUi(QMainWindow *social)
    {
        ...
        social->setStyleSheet(QStringLiteral("background-image: url(:/new/prefix1/LOGO.jpg);"));
...
"font: 10pt \"Comic Sans MS\";"));
        ...
        SearchButton->setStyleSheet(QLatin1String("color: rgb(0, 0, 255);\n"
"font: 10pt \"Comic Sans MS\";"));
        ...
        FirstNameLabel->setStyleSheet(QLatin1String("color: rgb(0, 0, 255);\n"
"font: 10pt \"Comic Sans MS\";"));
        ...
        LastNameLabel->setStyleSheet(QLatin1String("color: rgb(0, 0, 255);\n"
"font: 10pt \"Comic Sans MS\";"));
        ...
        toolBar = new QToolBar(social);
        toolBar->setObjectName(QStringLiteral("toolBar"));
        social->addToolBar(Qt::TopToolBarArea, toolBar);
    ...
    void retranslateUi(QMainWindow *social)
    {
        ...
        toolBar->setWindowTitle(QApplication::translate("social", "toolBar", 0));
    } // retranslateUi
