...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        Profile_Button->setStyleSheet(QStringLiteral("font: 12pt \"Comic Sans MS\";"));
        ...
        Handicap_Button->setStyleSheet(QLatin1String("font: 12pt \"Comic Sans MS\";\n"
""));
        ...
        NewsFeed_Button->setStyleSheet(QLatin1String("font: 12pt \"Comic Sans MS\";\n"
""));
        ...
        Track_Button->setStyleSheet(QStringLiteral("font: 12pt \"Comic Sans MS\";"));
        ...
        Rules_Button->setStyleSheet(QStringLiteral("font: 12pt \"Comic Sans MS\""));
        ...
        Social_Button->setStyleSheet(QStringLiteral("font: 12pt \"Comic Sans MS\";"));
